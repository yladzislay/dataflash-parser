...
using StructureParser.Formats.Battary;
using StructureParser.Formats.Communication;
using StructureParser.Formats.Custom.Engine;
using StructureParser.Formats.Custom.Powerboard;
using StructureParser.Formats.Custom.Unsorted;
using StructureParser.Formats.Engine;
using StructureParser.Formats.KalmanFilter.NKF;
using StructureParser.Formats.KalmanFilter.XKF;
using StructureParser.Formats.Navigation;
using StructureParser.Formats.Position;
using StructureParser.Formats.Sensors;
using StructureParser.Formats.System;
using StructureParser.Formats.Unsorted;

namespace StructureParser
{
